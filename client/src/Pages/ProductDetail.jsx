...
const ProductDetail = () => {
    ...
    const handleClick = (item) => {
        const message = `Saya ingin memesan ${item.name} seharga ${item.price} sebanyak ?`;
                        ...
                        <Flex marginTop="80px">
                            <Flex flex="1" padding="0 15px">
                                <Flex flexDirection="column" gap="7px">
                                    ...
                                    <Box width="160px" height="60px" borderRadius="10px" bg="#128C7E" marginTop="20px" onClick={() => handleClick(item)}>
